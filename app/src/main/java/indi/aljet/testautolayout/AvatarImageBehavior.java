...
/**
 * Created by LJL-lenovo on 2017/10/16.
 */

public class AvatarImageBehavior extends
        CoordinatorLayout.Behavior<CircleImageView> {

    private final static  float
    MIN_AVATAR_PERCENTAAGE_SIZE = 0.3f;


    private final static int
    EXTRA_FINAL_AVATAR_PADDING = 80;
    ...
    private void bindDimensions(){
        mAvatarMaxSize = mContext
                .getResources().getDimension(R
                .dimen.image_width);
    }
    ...
    private void shouldInitProperties(CircleImageView child,
                                      View dependency){
        // 图片控件中心
